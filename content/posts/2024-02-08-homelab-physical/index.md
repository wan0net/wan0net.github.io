...
*I highly recommend something like *[*draw.io*](http://draw.io/)* for network diagrams, until we can come up with an app that automatically makes them for us based on some kind of script*

> 🖼️ Image needs to be uploaded: physical-design.png
