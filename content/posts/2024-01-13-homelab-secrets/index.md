...
date: 2024-01-13
description: "homelab part x: secrets management"
draft: false
layout: "post"
slug: "homelab-secrets"
categories: ["homelab"]
preview: img-6defa6aa511c.png
feature: img-6defa6aa511c.png
---
...
> 🖼️ Image needs to be uploaded: vault-secrets.png

Once the secrets are in there, you can run envconsul. I create a [deploy.sh](http://deploy.sh/) file in each project folder, and for portainer it is.
